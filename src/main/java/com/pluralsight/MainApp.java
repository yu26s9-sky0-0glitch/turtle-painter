...
public class MainApp
{
    public static void main(String[] args) {
        ...
        Triangle triangleYellow = new Triangle(turtle,startingLocation,Color.YELLOW,3,80);
        Shape haxagonGray = new Haxagon(turtle,startingLocation,Color.GRAY,3,45);
        squareRed.paint();
       // circleGreen.paint();
        triangleYellow.paint();
        triangleYellow.paintEquilateral();
        haxagonGray.paint();
